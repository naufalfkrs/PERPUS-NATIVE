...
<head>
    ...
    <title>PERPUS SMK TELKOM MALANG</title>
</head>
<body>
    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link" aria-current="page" href="../Buku/buku.php">Buku</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" aria-current="page" href="../Buku/histori_peminjaman.php">Transaksi</a>
                </li>
                <li class="nav-item">
